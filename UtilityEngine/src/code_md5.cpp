...
void md5::update(ifstream& in) {
	...
	while (!in.eof()) {
		...
		length = in.gcount();
		if (length > 0) {
			update(buffer, std::size_t(length));
		}
	}
	in.close();
}
...
/* Convert uchar8 array to hex string. */
string md5::uchar8sToHexString(const unsigned char* input, size_t length) {
	string str;
...
string md5::toString() {
	return uchar8sToHexString(digest(), 16);
}
///////////////////////////////////////////////////////////////////////////////////////////////////
}//namespace code
///////////////////////////////////////////////////////////////////////////////////////////////////
